...
<template>
  <div class="user-settings p-4">
        ...
        <div id="user_setting_app" class="container form">
            ...
            <img class="profile_pic" v-bind:src="getObjFromUser('Jack').profile_pic">
            <div class="row">
                ...
                <div class="col-9" :key="update_pfps">
                    <template v-for="pfp_image of getObjFromUser('Jack').available_pics">
                        <img v-if="pfp_image === getObjFromUser('Jack').profile_pic" style="border: 5px solid cyan" class="profile_pic" :src="pfp_image" :key="pfp_image">
                        <img v-else class="profile_pic" :src="pfp_image" :key="pfp_image" @click="changeProfilePic('Jack', pfp_image)">
                    </template>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <form>
                        ...
                        <button @click="changeFirstName('Jack')" style="color:black">Save</button>
                    </form>
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <form>
                        ...
                        <button @click="changeLastName('Jack')" style="color:black">Save</button>
                    </form>
...
var user_data = [
    {
        ...
        available_pics: ["https://freefoodphotos.com/imagelibrary/fruit/slides/red_apple.jpg", "https://freefoodphotos.com/imagelibrary/fruit/slides/ripe_orange.jpg", "https://freefoodphotos.com/imagelibrary/fruit/slides/green_grapes.jpg"], //always the same for every user
